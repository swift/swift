...
MIXParticipantSerializer::MIXParticipantSerializer(PayloadSerializerCollection* serializers) : GenericPayloadSerializer<MIXParticipant>(), serializers_(serializers) {
}
